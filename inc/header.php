...
<head>
    ...
    <script type="text/javascript" src="assets/ablock.js"></script>
...
<div class="pre-header">
    <div class="container">
        ...
        <div class="col-md-6">
            <a href="tel:+33362729634" id="tel" target="_blank" > <i class="fa fa-phone"></i> 03.62.72.96.34</a>
        </div>
    </div>
</div>
<div class="header">
...
<div class="ip">
    <p>Votre IP : <?= $ip; ?> | <span class="label label-<?= $label; ?> label-sm"><?= $text; ?></span></p>
</div>